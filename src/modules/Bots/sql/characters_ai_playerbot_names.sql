...
LOAD DATA LOCAL INFILE 'E:/Mangosthree/serverThree/src/modules/Bots/sql/characters_ai_playerbot_names.csv' INTO TABLE ai_playerbot_names FIELDS TERMINATED BY ';';
